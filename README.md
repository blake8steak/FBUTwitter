...
* [X] Added menu action (Twitter Logo Button in top left) to auto-scroll back to top when pressed

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/blake8steak/FBUTwitter/blob/master/twitterIncludesLogin.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
